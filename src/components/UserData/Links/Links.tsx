    ...
    <div className='links'>
      <div className='vertical-box'>
        <div className='info-box'>
          <svg 
            className={classNames({'active': user?.location})}
            height="20" 
            width="20" 
        ...
        <div className='info-box'>
          <svg
            className={classNames({'active': user?.twitter_username})}
            height="18" 
            width="20" 
            xmlns="http://www.w3.org/2000/svg"
          >
      ...
      <div className='vertical-box'>
        <div className='info-box'>
          <svg
            className={classNames({'active': user?.blog})}
            height="20" 
            width="20" 
            xmlns="http://www.w3.org/2000/svg"
          >
        ...
        <div className='info-box'>
          <svg
            className={classNames({'active': user?.company})}
            height="20" 
            width="20" 
            xmlns="http://www.w3.org/2000/svg">
            <g>
          ...
          <span className={classNames({'active': user?.company})}>
